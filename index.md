...
`08/2022-present.`
**Associate Professor**, *Robotics & Mechatronics Department, School of Engineering and Digital Sciences, Nazarbayev University*, Kazakhstan.
...
Implementing and validating a neural-assisted, machine-learning-based intelligent  tutoring system that uses information from physiological signals to adapt the learning schedule to a user's individual learning capacity

`01/2015-12/2017.`
**Principal Investigator**, Development of a Brain-Computer Interface with a Robot and Functional-Electrical Stimulation for Upper-Limb Stroke Rehabilitation (BCI-ROBOFES)

`09/2014.` 
**Co-Investigator**, The BMI-Exo Project: Facilitating Personalized Robotic Rehabilitation Of The Upper Limb, [N.I.H. Grant R01NS081854-02, National Robotics Initiative] Lead a part of research that focuses on understanding neurophysiological correlates of motor learning during movements in stroke patients.

`09/2014.` 
**Co-Investigator**, Development of high-resolution subdural electrodes and data mining methods for precise localization of epileptogenic zone in treatment of patients with refractory epilepsy. Participated in idea generation and drafting/writing of the project proposal at Samsung Medical Center, Korea
...
`09/2004.` 
**Brain Korea Scholarship**, *Recipient of competitive graduate scholarship for an M.Sc. program*, South Korea.
...
**Software:** Expert in Python and libraries such as Cython; Good knowledge of C and C++. Experience with various tools and languages, including bash, LATEX, HTML, Git, database query languages, etc. 
...
C.H. Park, J.H Seo, D. Kim, <u>B. Abibullaev</u>, H. Kwon, Y.H. Lee, M.Y. Kim, K. Kim, J.S. Kim, E.Y. Joo, S.B. Hong, (2015, Feb). **Source Imaging in Partial Epilepsy in Comparison with Presurgical Evaluation and Magnetoencephalography**, *Journal of Clinical Neurology*, 2015 February 17, 11:e12. [[Link]](https://pubmed.ncbi.nlm.nih.gov/25749824/)
...
"**A System For Drivers' Cognitive Load Estimation Based On Deep Convolutional Neural Networks and Facial Feature Analysis**," in 22nd IEEE International Conference on Industrial Technology, Virtual 10-12, 2021, Spain.
...
Subject-Independent ERP-based Brain-Computer Interfaces**," in *2019
...
demonstration of humanoid robot controlled via a BCI system for
...
(RO-MAN), IEEE*, 2017, August 28 - September 1, Lisbon, Portugal.
...
cognition in the first two years of life - Early findings**. In *Society
...
Blank, J. A. French, N. Yozbatiran, and R. G. Grossman, M. K. O'Malley,
...
The Republic of Korea, June 12-14, 2014.
...
**Decoding Hemodynamic Brain Responses for Brain-Computer Interfaces
...
The United States, November 1-4, 2010.
...
Global Academic Networking*, Vladivostok, Russia, June 7-9, 2007.
